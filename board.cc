...
void Board::setup() {
  ...
  while (true) {
    ...
    if (cmd == "+" ) {
      ...
      if (arg1 == "p" || arg1 == "P") {
          p = make_unique<Pawn>(location.first, location.second, *this, isupper(arg1[0]));
      }
      if (arg1 == "k" || arg1 == "K") {
          p = make_unique<King>(location.first, location.second, *this, isupper(arg1[0]));
      }
      if (arg1 == "q" || arg1 == "Q") {
          p = make_unique<Queen>(location.first, location.second, *this, isupper(arg1[0]));
      }
      if (arg1 == "b" || arg1 == "B") {
          p = make_unique<Bishop>(location.first, location.second, *this, isupper(arg1[0]));
      }
      if (arg1 == "r" || arg1 == "R") {
          p = make_unique<Rook>(location.first, location.second, *this, isupper(arg1[0]));
      }
      if (arg1 == "n" || arg1 == "N") {
          p = make_unique<Knight>(location.first, location.second, *this, isupper(arg1[0]));
      }
